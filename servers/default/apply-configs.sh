...
files_to_copy=(
    ...
    ["./plugins/configs/terra/packs/default/biomes/land/mountains-large/boreal/coastal/rocky_sea_caves.yml"]="../../../server/plugins/Terra/packs/default/biomes/land/flat/mountains-large/boreal/coastal/rocky_sea_caves.yml"
